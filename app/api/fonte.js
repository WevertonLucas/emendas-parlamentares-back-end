module.exports = function(app) {
    //Objeto de callbacks de Fonte.
    let api = {};

    //Método que lista todas as Fontes.
    api.getFonte = (req, res) => {
        const connection = app.conexao.conexao(); //Cria uma conexão com o banco de dados.
        const fonteDAO = new app.infra.FonteDAO(connection); //Instância o objeto de acesso a dados, passando a conexão como parâmetro.
