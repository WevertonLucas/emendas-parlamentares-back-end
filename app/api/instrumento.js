module.exports = function(app) {
    //Objeto de callbacks de Instrumento.
    let api = {};

    //Método que Lista todos os Instrumentos.
    api.getInstrumento = (req, res) => {
        const connection = app.conexao.conexao(); //Cria uma conexão com o banco de dados.
        const instrumentoDAO = new app.infra.InstrumentoDAO(connection); //Instância o objeto de acesso a dados, passando a conexão como parâmetro.
