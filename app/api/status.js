module.exports = function(app) {
    //Objeto de callbacks de Status.
    let api = {};

    //Lista todos os Status.
    api.getStatus = (req, res) => {
        const connection = app.conexao.conexao(); //Cria uma conexão com o banco de dados.
        const statusDAO = new app.infra.StatusDAO(connection); //Instância o objeto de acesso a dados, passando a conexão como parâmetro.
