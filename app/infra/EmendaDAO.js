class EmendaDAO {
    ...
    getEmendaById(cod_emenda, callback) {
        this._connection.query(
            `SELECT *, fonte.descricao AS fonte, gnd.descricao AS gnd, modalidade.descricao AS modalidade,
            ...
            INNER JOIN municipio ON emenda.cod_ibje = municipio.cod_ibge
            INNER JOIN autor ON emenda.cod_autor = autor.cod_autor
            ...
            INNER JOIN status ON emenda.cod_status = status.cod_status
            INNER JOIN instrumento ON emenda.cod_instrumento = instrumento.cod_instrumento
